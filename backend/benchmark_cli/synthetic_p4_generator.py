...
"""
        ...
        if logic_type == 'sequential':
            ...
            raise ValueError(f"Unknown ingress logic type: {logic_type}")
...
if __name__ == "__main__":
    ...
    print("Generating synthetic P4 programs...")
    for parser_states, ingress_tables, egress_tables in test_configs:
        ...
        print(f"✓ Generated (Sequential): {metadata_seq['id']}")
        ...
        print(f"✓ Generated (Parallel):   {metadata_par['id']}")
    ...
    print(f"\n✓ {len(manifest)} programs generated in {output_dir}")
